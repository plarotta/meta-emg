...
##minmax
### cnn
python train.py 'test.run_name=terremoto_timeseq_50_minmax_cnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=50' 'test.scale=2' 'test.model=cnn'

python train.py 'test.run_name=terremoto_timeseq_60_minmax_cnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=60' 'test.scale=2' 'test.model=cnn'

python train.py 'test.run_name=terremoto_timeseq_70_minmax_cnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=70' 'test.scale=2' 'test.model=cnn'

python train.py 'test.run_name=terremoto_timeseq_80_minmax_cnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=80' 'test.scale=2' 'test.model=cnn'

python train.py 'test.run_name=terremoto_timeseq_90_minmax_cnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=90' 'test.scale=2' 'test.model=cnn'

### tcn
python train.py 'test.run_name=terremoto_timeseq_50_minmax_tcn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=50' 'test.scale=2' 'test.model=tcn'

python train.py 'test.run_name=terremoto_timeseq_60_minmax_tcn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=60' 'test.scale=2' 'test.model=tcn'

python train.py 'test.run_name=terremoto_timeseq_70_minmax_tcn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=70' 'test.scale=2' 'test.model=tcn'

python train.py 'test.run_name=terremoto_timeseq_80_minmax_tcn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=80' 'test.scale=2' 'test.model=tcn'

python train.py 'test.run_name=terremoto_timeseq_90_minmax_tcn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=90' 'test.scale=2' 'test.model=tcn'

### dnn
python train.py 'test.run_name=terremoto_timeseq_50_minmax_dnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=50' 'test.scale=2' 'test.model=dnn'

python train.py 'test.run_name=terremoto_timeseq_60_minmax_dnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=60' 'test.scale=2' 'test.model=dnn'

python train.py 'test.run_name=terremoto_timeseq_70_minmax_dnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=70' 'test.scale=2' 'test.model=dnn'

python train.py 'test.run_name=terremoto_timeseq_80_minmax_dnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=80' 'test.scale=2' 'test.model=dnn'

python train.py 'test.run_name=terremoto_timeseq_90_minmax_dnn' 'test.inner_lr=1e-4' 'test.outer_lr=5e-4' 'test.meta_steps=30' 'test.inner_steps=3' 'test.n_val_tasks=5' 'test.n_train_tasks=1' 'test.save=True' 'test.wandb=True' 'test.time_seq_len=90' 'test.scale=2' 'test.model=dnn'
